...
// This component handles the smooth reveal animations
  ...
  return (
    <div className="py-24 px-6 md:px-20 max-w-7xl mx-auto">
      <FadeIn className={`max-w-4xl ${alignmentClasses[align]}`}>
        {title && (
          <p className="font-mono text-xs font-bold uppercase tracking-widest text-orange-600 mb-6">
            {title}
          </p>
        )}
        <div className="text-3xl md:text-5xl font-serif leading-tight text-slate-900 space-y-8">
          {children}
        </div>
      </FadeIn>
    </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <FadeIn>
          <div className="relative group flex justify-center">
            <div className="absolute inset-0 bg-orange-100 rounded-full blur-3xl opacity-40 group-hover:opacity-60 transition-opacity"></div>
            <img 
              src="/tony.png" 
              alt="Tony Low" 
        ...
        <FadeIn delay={200}>
          ...
          <div className="space-y-6 text-lg md:text-xl text-slate-600 font-sans leading-relaxed">
            <p>
              Tony works in high tech sales, but cooking is where he gets to be creative. He calls his happy place the <span className="font-bold text-orange-600">Kitchen Lab</span>, where he turns experiments with recipes he sees amidst his travels, recalls from his experiences, and learned from his family.
            </p>
            <p>
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-slate-900 selection:bg-orange-200 selection:text-orange-900 font-sans">
      ...
      <StoryBlock title="02. The Recipe" align="right">
        ...
        <p className="italic text-slate-500">"Hey Jack," they'd call out at the fish markets, giving him the best pick.</p>
      </StoryBlock>
      ...
      <StoryBlock title="03. Affection" align="center">
        ...
        <p className="text-xl text-slate-500">She'd stand at the stove for hours with one knife and a cleaver. The best piece of fish always went to the kids.</p>
      </StoryBlock>
      ...
      <StoryBlock title="04. Memory">
        ...
        <p className="text-orange-700 font-bold">When she'd crack an egg into the wok, Tony knew the dish was minutes away.</p>
      </StoryBlock>
